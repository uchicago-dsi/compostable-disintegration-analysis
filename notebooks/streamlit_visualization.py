...
st.markdown('#### Disintegration Rate Analysis by Items')
item_residual = bar_whisker_plot(df_selected_trial, 'item_name', residual, cap_anomalies)
st.pyplot(plt)

st.markdown('#### Disintegration Rate Analysis by Material Class')
material_residual = bar_whisker_plot(df_selected_trial, material, residual, cap_anomalies)
st.pyplot(plt)